...
public class Reporte {
    ...
    public static final String Carta_Compromiso = "Carta_CompromisoSS";
    ...
    public void establecerDatos(String documento, Object obj) {
        ...
        try {
            ...
            jasperPrint = JasperFillManager.fillReport(rutaReporteRaiz.concat("/").concat(documento).concat(tipo), parametros, new JRBeanCollectionDataSource(lista));
