...
<div id="inactivos">
    <%
        List<ProgramaSS> list3 = pdao.getListProgramasByEdoCatego(new CategoriaPrograma(1), new CEstado((short) 2));
    ...
    <%
            ...
            out.println("<h1>Actualmente no hay Programas Internos inactivos</h1>");
        }
    %>
</div>
