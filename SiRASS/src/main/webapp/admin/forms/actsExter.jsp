...
<div id="progActs">
    <%
        ...
        List<ProgramaSS> list = pdao.getListProgramasByEdoCatego(new CategoriaPrograma(2),new CEstado((short) 1));
    ...
    <%
            ...
            out.println("<h1>No hay Programas Externos actualmente Activos</h1>");
        }
    %>
</div>
