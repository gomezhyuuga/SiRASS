...
<div id="suspendidos">
    <%
        List<ProgramaSS> list2 = pdao.getListProgramasByEdoCatego(new CategoriaPrograma(2),new CEstado((short) 3));
    ...
    <%
            ...
            out.println("<h1>No se ha solicitado baja de Programas Externos actualmente</h1>");
        }
    %>
</div>