...
<div id="progRegistrado">
    <%
        ...
        List<ProgramaSS> list = pdao.getListProgramasByEdoCatego(new CategoriaPrograma(2),new CEstado((short) 4));
    ...
    <%
            ...
            out.println("<h1>No hay Programas Externos registrados recientemente</h1>");
        }
    %>
</div>