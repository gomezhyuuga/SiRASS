            ...
            <div class="row">
                ...
                <div class="span8 solid">
                    ...
                    <div class="breadcrumb">
                        <a class="btn btn-success" href="./"><i class="icon-plus icon-white"></i> Registrados</a> <span class="divider">/</span>
                        ...
                        <a class="btn btn-info" href="./activos.jsp"><i class="icon-question-sign icon-white"></i> Activos</a><span class="divider">/</span>
